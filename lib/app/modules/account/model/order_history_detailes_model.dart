...
OrderHistoryDetailesModel orderHistoryDetailesModelFromJson(String str) =>
    OrderHistoryDetailesModel.fromJson(json.decode(str));

String orderHistoryDetailesModelToJson(OrderHistoryDetailesModel data) =>
...
class OrderHistoryDetailesModel {
  ...
  factory OrderHistoryDetailesModel.fromJson(Map<String, dynamic> json) =>
      OrderHistoryDetailesModel(
